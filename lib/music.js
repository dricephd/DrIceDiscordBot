...
var checkQueue = function() {
	...
	if (currentSong != "None") {
		...
		ticker = "[" + (time) + "/" + getTimeStamp(currentSong.duration) + "] - " + currentSong.title + " - " + currentSong.requester;
		bot.setChannelTopic(musicStatusChannel,ticker);
	...
	if (currentSong == "None") {
		...
		bot.setStatus("online",null,function (error) {
			if (error) console.log(error);
		});
	}
