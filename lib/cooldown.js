...
// callback(error,boolean onCooldown)
function checkCooldown(msg,callback) {
	...
	return callback( new Error('Unexpected error occured'), null);
}
module.exports = {checkCooldown,Setup};